...
# ==================================================================
# P2完成版: 戦力評価ブレンド(v3.1)
# 選手の見込みpt/G = w×ESPN季節予測 + (1-w)×実力推定(直近実績PPGとxFPの平均)
# w(ESPN予測の重み)は出場試合数で減衰。アンカー間は線形補間、以降は下限で固定
# ==================================================================
BLEND_W_ANCHORS = {0: 1.0, 1: 0.9, 5: 0.5, 10: 0.3}  # 出場数→ESPN重み
BLEND_RECENT_WEEKS = 4       # 実力推定に使う直近出場週数

# トレードジェネレーター
TRADE_OPP_MAX_LOSS = 2.0     # ○要交渉: 相手の週次損失がこのpt以内なら提示
TRADE_TOP_RESIM = 10         # Δ優勝確率を再シミュする上位案の数
TRADE_RESIM_SIMS = 3000      # 再シミュの試行回数(全体シミュより軽く)
TRADE_MAX_SHOWN = 12         # 表示する最大案数
DIAMOND_BACKING = {
